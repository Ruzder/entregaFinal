	...
	<div class="container">
		<div class="contact-box">
			...
			<div class="right">
				...
				<form
					action="${pageContext.request.getContextPath()}/crearProfesionalUsuario"
					method="post">
					...
					<div class="mb-3">
						<label for="idProfesional" class="form-label">id Profesional</label> <input
							type="number" class="form-control" id="idInt"
							name="idInt">
					</div>
					<div class="mb-3">
						<label for="expPro" class="form-label">Experiencia</label> <input
							type="text" class="form-control" id="expTxt"
							name="expTxt">
					</div>
					<div class="mb-3">
						<label for="depPro" class="form-label">Departamento</label> <input
							type="text" class="form-control" id="depTxt"
							name="depTxt">
					</div>
					<div class="mb-3">
						<label for="titulopro" class="form-label">Titulo Profesional</label> <input
							type="text" class="form-control" id="titTxt"
							name="titTxt">
					</div>
					<div class="mb-3">
						<label for="fecha" class="form-label">fecha contratacion</label> <input
							type="text" class="form-control" id="fecPTxt"
							name="fecPTxt">
					</div>					
