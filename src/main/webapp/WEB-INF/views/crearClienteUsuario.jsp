	...
	<div class="container">
		<div class="contact-box">
			...
			<div class="right">
				<h2>Crear Cliente</h2>
				<form
					action="${pageContext.request.getContextPath()}/crearClienteUsuario"
					method="post">
					
					<div class="mb-3">
						<label for="id" class="form-label">RUN</label> <input type="number"
					...
					<div class="mb-3">
						<label for="rutCliente" class="form-label">Rut Cliente</label> <input
							type="number" class="form-control" id="rutInt"
							name="rutInt">
					</div>
					<div class="mb-3">
						<label for="dirCliente" class="form-label">Direccion</label> <input
							type="text" class="form-control" id="dirTxt"
							name="dirTxt">
					</div>
					<div class="mb-3">
						<label for="comCliente" class="form-label">Comuna</label> <input
							type="text" class="form-control" id="comTxt"
							name="comTxt">
					</div>
					<div class="mb-3">
						<label for="canEmpCliente" class="form-label">Cantidad Empleados</label> <input
							type="number" class="form-control" id="canInt"
							name="canInt">
					</div>
					<div class="mb-3">
						<label for="telCliente" class="form-label">Telefono</label> <input
							type="text" class="form-control" id="telTxt"
							name="telTxt">
					</div>
